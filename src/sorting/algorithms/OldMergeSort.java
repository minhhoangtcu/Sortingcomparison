/**
 * This Merge Sort algorithm was replaced by the required algorithm implemented in the book
 */
package sorting.algorithms;

import java.util.ArrayList;

public class OldMergeSort<T extends Comparable<T>> extends SortingAlgorithm<T> {
	
	public OldMergeSort(T[] input) {
		super();
		sort(input);
