...
public class HTMLSortingTextGenerator {
	...
	public static <T extends Comparable<T>> String getInfo(SortingAlgorithm<T> sorting) {
		...
		builder.append("<h1 style='text-align: center'>" + Sort.SORTING_METHODS[sortingMethod] + "</h1>");
		builder.append("<p style='font-style: italic; margin: 0px'>" + sorting.getDescription() + "<br>");
		builder.append(String.format("Expected compares: <b>%s</b> and moves: <b>%s</b></p><br>", Sort.SORTING_SPEED_COMPARES[sortingMethod], Sort.SORTING_SPEED_MOVES[sortingMethod]));
